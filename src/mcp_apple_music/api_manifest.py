...
ENDPOINTS: tuple[Endpoint, ...] = (
    ...
    Endpoint("library_resource_get", "library", "Get one library resource", "GET", "/me/library/{library_path}/{id}", "user", ("resource_type", "id", "include"), LIBRARY_RESOURCE_TYPES),
    Endpoint("library_resource_multiple", "library", "Get multiple library resources", "GET", "/me/library/{library_path}", "user", ("resource_type", "ids", "include"), LIBRARY_RESOURCE_TYPES),
    Endpoint("library_resource_all", "library", "Get all library resources", "GET", "/me/library/{library_path}", "user", ("resource_type", "limit", "offset"), LIBRARY_RESOURCE_TYPES),
    Endpoint("library_resource_relationship", "library", "Get library resource relationship", "GET", "/me/library/{library_path}/{id}/{relationship}", "user", ("resource_type", "id", "relationship", "limit", "offset"), LIBRARY_RESOURCE_TYPES),
    Endpoint("library_add_resource", "library", "Add a resource to a library", "POST", "/me/library", "user", ("ids[{resource_type}]",), ("albums", "songs", "music-videos", "playlists"), True),
    ...
    Endpoint("library_playlist_folder_get", "playlists", "Get a library playlist folder", "GET", "/me/library/playlist-folders/{id}", "user", ("id", "include"), ("library-playlist-folders",)),
    ...
    Endpoint("favorites_add_resource", "favorites", "Add resource to favorites", "POST", "/me/favorites", "user", ("ids[{resource_type}]",), CATALOG_RESOURCE_TYPES + LIBRARY_RESOURCE_TYPES, True),
    Endpoint("replay_user_data", "replay", "Get user's replay data", "GET", "/me/music-summaries", "user", ("filter[year]", "l", "limit", "offset")),
    ...
    Endpoint("history_recently_played_stations", "history", "Get recently played stations", "GET", "/me/recent/radio-stations", "user", ("limit", "offset")),
    ...
    Endpoint("multi_resource_catalog_typed_ids", "multi_resource", "Get multiple catalog resources by typed IDs", "GET", "/catalog/{storefront}", "catalog", ("storefront", "ids[{resource_type}]", "l", "include"), CATALOG_RESOURCE_TYPES),
    Endpoint("multi_resource_library_typed_ids", "multi_resource", "Get multiple library resources by typed IDs", "GET", "/me/library", "user", ("ids[{resource_type}]", "include"), LIBRARY_RESOURCE_TYPES),
...
ENDPOINT_TOOL_MAP = {
    ...
    "library_playlist_folder_get": "get_library_playlist_folder",
